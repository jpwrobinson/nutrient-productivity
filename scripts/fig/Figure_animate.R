...
g3<-ggplot(prod_fg, aes((nutprop), col=dietP_lab, fill=dietP_lab)) + 
  ...
  labs(x=expression(paste('daily calcium production (mg day'^'-1',' ha'^'-1', ')')), y = 'density') +
  th + theme(legend.position = 'none') +
  transition_states(nutrient_lab, transition_length = 3, state_length = 2) +
